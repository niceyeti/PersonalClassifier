...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  string inputDirectory = "../resources/personnel/";
  string testSampleFile = "../resources/personnel/sample.txt";
  //vector<string> inputFileList = {"../resources/personnel/dasovich/","../resources/personnel/kean/","../resources/personnel/germany/","../resources/personnel/shackleton/","../resources/personnel/jones/"}; 
  personalClassifier.classify(inputDirectory,testSampleFile);
